...
- Jogadores que apreciam storytelling profundo
- Público interessado em temas sociais e filosóficos

### c) Game Flow

| Fase | Descrição | Duração | Mecânicas Principais | Consequências |
|------|-----------|---------|----------------------|---------------|
| **Dia 1** | Avenida - Despertar e pânico moral | 20-30 min | Sobrevivência, escolhas iniciais | Define personalidade base |
| **Dia 2** | Fliperama - Conflito de gênero | 20-30 min | Alianças, confrontos | Estabelece relações |
| **Dia 3** | Beco - Racismo estrutural | 20-30 min | Justiça, moralidade | Desenvolve valores |
| **Dia 4** | Refúgio - Consequências | 20-30 min | Estratégia, liderança | Mostra resultados |
| **Dia 5** | Cerco - Ponto sem retorno | 20-30 min | Sobrevivência extrema | Testa limites |
| **Dia 6** | Revelação - Verdade sobre J3 | 20-30 min | Descoberta, aceitação | Revela origem |
| **Dia 7** | Final - Escolha definitiva | 15-25 min | Resolução final | 4 finais possíveis |

**Tempo Total Estimado:** 2-3 horas

### d) Estilo Estético
**Cyberpunk Noir Brasileiro**
- **Visual:** 2D digital com paleta de cores escuras e neon
- **Atmosfera:** Urbana, chuvosa, melancólica
- **Inspirações:** Blade Runner, Cyberpunk 2077, cultura brasileira contemporânea
- **Tom:** Sombrio, reflexivo, socialmente crítico
...
- **Sistema de Sobrevivência:**
  - **Bateria (0-100%):** Consome com cada ação, 0% = game over
  - **Integridade (0-100%):** Danos físicos acumulativos, 0% = colapso
...
### f) Objetos
**Objetos Interativos:**
- **Estações de Recarga:** Restauram 15-25% de bateria
- **Kits de Reparo:** Restauram 10-20% de integridade
...
- **Confronto:** Enfrentar agressoresfísica ou verbalmente
...
- **Conflito Verbal:** Escolhas de diálogo que podem destrair ou escalonar situações
...
#### Direção de Arte
**Estilo Cyberpunk Noir Brasileiro**
- **Paleta de Cores:**
  - **Primárias:** Azul escuro, roxo, neon verde
  - **Secundárias:** Cinza, preto, laranja neon
  - **Acentos:** Vermelho para alertas, branco para interfaces

- **Composição Visual:**
  - **Contraste Alto:** Luz vs sombra dramático
  - **Perspectiva:** Ângulos baixos para mostrar opressão
  - **Simetria:** Quebrada para representar caos social

#### Inspirações Visuais
- **Cinema:** Blade Runner, Akira, Ghost in the Shell
- **Games:** Cyberpunk 2077, Detroit: Become Human
- **Cultura Brasileira:** Grafite urbano, arquitetura brutalista

#### Elementos Chave
- **Personagens:** Sprites 2D com múltiplas expressões
- **Cenários:** Backgrounds detalhados com atmosfera urbana
- **Interface:** HUD integrado ao sistema de J3
- **Efeitos:** Partículas de chuva, neon piscando, glitch
...
**Ato 1 - Despertar (Dias 1-3):**
- Introdução ao mundo e aos personagens
- Estabelecimento do sistema de personalidade
- Primeiros contatos com preconceito e discriminação

**Ato 2 - Confronto (Dias 4-5):**
- Consequências das escolhas anteriores
- Desenvolvimento de alianças e inimizades
- Escalada dos conflitos sociais

**Ato 3 - Revelação (Dias 6-7):**
- Descoberta da verdade sobre sua origem
- Escolha final que define o destino
- Resolução baseada na personalidade desenvolvida
...
#### Plataformas Alvo
- **PC (Windows):** Windows 7 ou superior (64-bit)
- **PC (Linux):** Ubuntu 18.04 ou superior
- **PC (macOS):** macOS 10.12 ou superior
...
- **Arte:** Krita (grátis) ou Photoshop (pago)
...
### Conformidade MINC
Este GDD atende a 100% dos requisitos estabelecidos pelo Manual MINC para Games, incluindo:
- Representatividade étnico-racial e de gênero
- Diversidade cultural brasileira
- Formato técnico completo
- Aspectos culturais e sociais relevantes

---

**Local:** Brasil, 03 de abril de 2026
