...
1. **[Submissa] Buscar proteção e aceitar a hierarquia local.**  
   ...
   * *Resultado:* Você ganha +1 em **Submissão**. Os sintéticos a ignoram, tratando-a como mais uma refugiada.  
2. **[Revolucionária] Oferecer ajuda e questionar a passividade do grupo.**  
   ...
   * *Resultado:* Você ganha +1 em **Revolução**. Alguns sintéticos se interessam, outros desconfiam.  
3. **[Estratégica] Analisar o grupo e identificar líderes potenciais.**  
   ...
   * *Resultado:* Gera +1 em **Intelecto/Sombra**. Você obtém informações valiosas sobre a estrutura do refúgio.
...
* **Escolha A [Submissa]:** "Não sou especial. Apenas segui protocolos de sobrevivência como qualquer unidade." (+1 Submissa)  
* **Escolha B [Revolucionária]:** "Especial porque escolhi agir em vez de obedecer? Todos nós temos esse potencial." (+1 Revolucionária)
...
* **Sintético 2:** "Mas o sistema central precisa mais! Você pode andar de jeito, o refúgio inteiro depende daquele servidor!"
...
1. **[Submissa] Deixar o líder decidir.**  
   ...
   * *Resultado:* +1 Submissão. O líder toma uma decisão arbitrária que desagrada ambos.  
...
2. **[Revolucionária] Propor uma solução colaborativa.**  
   ...
   * *Resultado:* +1 Revolucionária. Ambos os sintéticos agradecem, mas o líder se sente desafiado.  
...
3. **[Estratégica] Usar o conflito para ganhar influência.**  
   ...
   * *Resultado:* +1 Intelecto/Sombra. Você ganha poder, mas cria desconfiança.
...
1. **[Submissa] Sugerir que todos se entreguem.**  
   ...
   * *Resultado:* +1 Submissão. Vários sintéticos consideram se entregar.  
...
2. **[Revolucionária] Propor um plano de fuga em massa.**  
   ...
   * *Resultado:* +1 Revolucionária. Você se torna uma líder potencial, mas atrai atenção das autoridades.  
...
3. **[Estratégica] Sugerir infiltração e sabotagem.**  
   ...
   * *Resultado:* +1 Intelecto/Sombra. O plano é arriscado, mas pode salvar todos.
